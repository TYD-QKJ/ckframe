/**
 * required :jquery1.10.js jquery.CommonUtil.js var obj;
 * 
 * @classDescription $(function(){ obj = new widget_textarea({height :
 *                   "560px"}); obj.init("editor1"); });
 */
var widget_textarea = function(config) {
	...
	var iframeobj = null;
	this.defaultConfig = { width : "100%", height : "560px", src : "/ckframe/widget_textarea.jsp" };
	this.option = {};
 ...
 * 需要jqueryui 1.10的包支持
 * 
 * @classDescription var wb1; $(function(){ wb1 = new widget_button({ inputid :
 *                   "ordermobile", objname : "wb1" }); wb1.init(); });
 */
var widget_button = function(config) {
	...
	this.create = function() {
		...
		$("#" + iframeid).css({ width : "100%", height : selfobj.option.height, background : "transparent" });
